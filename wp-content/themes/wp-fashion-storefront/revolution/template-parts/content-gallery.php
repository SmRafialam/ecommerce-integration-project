...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	<div class="card-item card-blog-post">
		<?php
		    ...
		    $wp_fashion_storefront_gallery_shortcode = get_post_gallery();

			if (!is_singular() && !empty($wp_fashion_storefront_gallery_shortcode)) {
				if (!empty($wp_fashion_storefront_gallery_shortcode)) {
					// Display the gallery
					echo '<div class="embedded-gallery">' . do_shortcode($wp_fashion_storefront_gallery_shortcode) . '</div>';
				}
			}
		?>
