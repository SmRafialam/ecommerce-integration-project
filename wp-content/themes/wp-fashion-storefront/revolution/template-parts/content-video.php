		...
		<?php
			...
			if (!is_singular() && !empty($wp_fashion_storefront_embeds)) {
			    ...
			    foreach ($wp_fashion_storefront_embeds as $wp_fashion_storefront_embed) {
			        ...
			        if (strpos($wp_fashion_storefront_embed, 'video') !== false || strpos($wp_fashion_storefront_embed, 'youtube') !== false || strpos($wp_fashion_storefront_embed, 'vimeo') !== false || strpos($wp_fashion_storefront_embed, 'dailymotion') !== false || strpos($wp_fashion_storefront_embed, 'vine') !== false || strpos($wp_fashion_storefront_embed, 'wordPress.tv') !== false || strpos($wp_fashion_storefront_embed, 'hulu') !== false) {
			            ?>
