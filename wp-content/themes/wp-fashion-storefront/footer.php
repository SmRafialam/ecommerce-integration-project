...
<?php 
  $wp_fashion_storefront_main_slider_wrap = absint(get_theme_mod('wp_fashion_storefront_enable_footer', 1));
				...
				<div class="container">
					<div class="flex-row">
						...
						<aside id="categories-2" class="widget widget_categories">
							<h2 class="widget-title"><?php esc_html_e('Tags', 'wp-fashion-storefront'); ?></h2>
							<div class="tagcloud">
								<?php
								$tags = get_tags();
								if ($tags) {
									...
									echo '<p>' . esc_html__('No tags available. Add some tags to display here.', 'wp-fashion-storefront') . '</p>';
								}
								?>
							</div>
						</aside>
	                ...
	                <div>
		                <?php
		                    if (!get_theme_mod('wp_fashion_storefront_copyright_option') ) { ?>
		                      <a href="<?php echo esc_url('https://www.revolutionwp.com/products/free-storefront-wordpress-theme'); ?>" target="_blank">
