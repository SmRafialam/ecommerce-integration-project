...
<div class="container">
	<?php
	$wp_fashion_storefront_post_layout = get_theme_mod( 'wp_fashion_storefront_post_layout', 'layout-1' );

	if ( $wp_fashion_storefront_post_layout == 'layout-1' ) {
		?>
	...
	<?php
	} elseif ( $wp_fashion_storefront_post_layout == 'layout-2' ) {
		?>
	<div class="main-wrapper">
		<?php get_sidebar(); ?>
	...
	<?php 
	} elseif ( $wp_fashion_storefront_post_layout == 'layout-3' ) { // No-sidebar layout
	?>
